...
setBranchNums_LGD = function() {
  ...
  n_branch_list = list(n.pops.main = 31,           # number of main branches
                       ...
                       n.pops.Imnaha = c(6,6,3),   # number of initial bins in Imnaha branch, number of branches above IR3, number of branches above IR5
